...
units(14) ={'$E0_b$ ($\mu$mol~cm$^{-2}$)'}; 
units(15) ={'$k1f_b$ (cm$^{3}$~s$^{-1}~\mu$mol$^{-1}$)'};
units(16) ={'$k2f_b$ (s$^{-1}$)'}; 
units(17) ={'$k3f_b$ (s$^{-1}$)'}; 
units(18) ={'$k1b_b$ (s$^{-1}$)'}; 
units(19) ={'$k2b_b$ (s$^{-1}$)'};
units(20) ={'$k3b_b$ (cm$^{3}$~s$^{-1}~\mu$mol$^{-1}$)'}; 
units(21) ={'$\sigma$ ($\mu$mol~cm$^{-2}$~h$^{-1}$)'};

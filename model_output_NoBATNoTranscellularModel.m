%% model_output_NoBATNoTranscellularModel.m
...
% Solidoro (2018) without the BAT or transcellular mechanisms. 
...
function model_predictions = model_output_NoBATNoTranscellularModel(parameter_vals,dataset)

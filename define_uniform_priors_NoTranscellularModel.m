%% define_uniform_priors_NoTranscellularModel.m
function [Prior_uppers, Prior_lowers] = define_uniform_priors_NoTranscellularModel
...
% Solidoro (2018) where the transcellular pathway mechanism is excluded.  

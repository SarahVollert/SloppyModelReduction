...
% This function calculates the effective sample size for a distribution
% specified by the new temperature (newgamma), given the old temperature,
% particle weights and the logliklihoods of the particles. 

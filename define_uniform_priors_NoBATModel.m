%% define_uniform_priors_NoBATModel.m
function [Prior_uppers, Prior_lowers] = define_uniform_priors_NoBATModel
...
% Solidoro (2018) where the BAT mechanism is excluded.  

function units = define_parameter_units_NoBATNoTranscellularModel(n_params)
...
% passive transcullular pathway for CO2 or the BAT pump mechanism.
...
units(13) ={'$\sigma$ ($\mu$mol~cm$^{-2}$~h$^{-1}$)'};
